...
_VISION_OBSERVATIONS = [
    'basket_back_left/pixels', 'basket_front_left/pixels',
...
_INTERACTIVE_IMITATION_LEARNING_OBSERVATONS = [
    'sawyer/joints/angle',
    'gripper/joints/angle',
    'sawyer/pinch/pose',
    'sawyer/tcp/pose',
...
class ObservationSet(int, enum.Enum):
  ...
  INTERACTIVE_IMITATION_LEARNING = (
      3, _INTERACTIVE_IMITATION_LEARNING_OBSERVATONS)
  OFFLINE_POLICY_IMPROVEMENT = (4, _OFFLINE_POLICY_IMPROVEMENT_OBSERVATIONS)


def rgb_stacking(
    object_triplet: str = 'rgb_test_triplet1',
